...
#else
	context->mac_addr[0] = CONFIG_ETH_KSDK_0_MAC0;
	context->mac_addr[1] = CONFIG_ETH_KSDK_0_MAC1;
	context->mac_addr[2] = CONFIG_ETH_KSDK_0_MAC2;
	context->mac_addr[3] = CONFIG_ETH_KSDK_0_MAC3;
	context->mac_addr[4] = CONFIG_ETH_KSDK_0_MAC4;
	context->mac_addr[5] = CONFIG_ETH_KSDK_0_MAC5;
#endif
